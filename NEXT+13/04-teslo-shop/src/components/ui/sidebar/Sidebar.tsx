    ...
    <div>
      {
        isSideMenuOpen && (
          <>
            ...
            {/* Blur */}
            <div className="fade-in fixed top-0 w-screen h-screen z-10 backdrop-filter backdrop-blur-sm" onClick={ closeSideMenu }/>
          </>
        )
      }
      ...
      <nav className={
        ...
        <div className="relative mt-14">
          ...
          <input type="text" placeholder="Buscar" className="w-full bg-gray-50 rounded pl-10 py-1 pr-10 border-b-2 text-xl border-gray-200 focus:border-blue-500"/>
        </div>
